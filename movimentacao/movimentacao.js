...
import { formatDateTime, formatDuration, todayISO, badgeHtml, escapeHtml, showMessage, attachCpfMask } from '../shared/utils.js';
...
export async function initMovimentacao(auth) {
  ...
  attachCpfMask(document.getElementById('motoristaDoc'));
